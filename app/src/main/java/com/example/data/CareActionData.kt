...
object CareActionRegistry {
  val actionsByRoom = mapOf(
    RoomType.SLEEP to listOf(
      ...
      CareAction("praise_sleep", CareActionType.PRAISE, "Lullaby", "🎵", RoomType.SLEEP, 4, "Sing a gentle lullaby", "+15 Joy • +10 Love")
    ),
    RoomType.KITCHEN to listOf(
      ...
      CareAction("water", CareActionType.WATER, "Give Water", "💧", RoomType.KITCHEN, 3, "Provide fresh cool water", "+15 Water • +10 Energy")
    ),
    RoomType.BATH to listOf(
      ...
      CareAction("brush", CareActionType.BRUSH, "Brush Fur", "🪮", RoomType.BATH, 3, "Groom fur to make it fluffy", "+20 Clean • +10 Love")
    ),
    RoomType.PLAY to listOf(
      ...
      CareAction("hug", CareActionType.PET_HUG, "Cuddle & Hug", "🫂", RoomType.PLAY, 3, "Give warm loving hugs", "+20 Love • +15 Joy")
    ),
    RoomType.GARDEN to listOf(
      CareAction("praise", CareActionType.PRAISE, "Praise Mochi", "🌟", RoomType.GARDEN, 3, "Give sweet words of praise", "+25 Joy • +15 Love"),
